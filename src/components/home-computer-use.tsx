...
const notes = [
  { title: "Saturday plan", snippet: "Dinner, school form, groceries", time: "1:18 PM" },
  { title: "Groceries", snippet: "Compare Aldi vs Market Lane", time: "12:02 PM" },
  { title: "Trip ideas", snippet: "Lisbon — flights + hotel", time: "Yesterday" },
              ...
              <div className={styles.mailToolbar}>
                <button type="button" className={styles.sendButton}>
                  <svg viewBox="0 0 24 24" aria-hidden="true">
                    <path d="M3 11.5 21 3l-8.5 18-2.4-7.1Z" fill="currentColor" />
                  </svg>
                </button>
              ...
              <div className={styles.notesBody}>
                ...
                <div className={styles.noteEditor}>
                  ...
                  <p className={styles.noteText}>
                    Tickets are in the top drawer. Leave by 7:00 to make the table.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className={`${styles.cursor} ${styles.cursorStella}`}>
              ...
              <span className={styles.cursorLabel}>
                <span className={styles.cursorLabelMark}>
                  <Image src="/stella-logo.svg" alt="" width={9} height={9} />
                </span>
                Stella
              </span>
            </div>
