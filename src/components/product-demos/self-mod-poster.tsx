...
const POSTER_STAGE = SELF_MOD_STAGES[2];

export function SelfModificationPoster() {
  return (
    <div className="selfmod-layout" aria-label="Static preview of Stella customization demo">
      <div className="selfmod-canvas">
        <div className="selfmod-canvas__capture">
          <div className="selfmod-shell" data-stage={POSTER_STAGE.id}>
                ...
                <div className="selfmod-shell__workspace">
                  <div className="selfmod-shell__content">
                    ...
                    <div className="selfmod-options">
                      {SELF_MOD_STAGES.map((stage) => (
                        <button
                          key={stage.id}
                          type="button"
                          className="selfmod-option"
                          data-active={POSTER_STAGE.id === stage.id || undefined}
                        >
                    ...
                    <div className="selfmod-poster-note">
                      Interactive preview loads once the page settles or when you interact.
                    </div>
                  </div>
                </div>
              </div>
